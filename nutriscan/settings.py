...
SECRET_KEY = 'django-insecure-_ixjsgj!4+*n5_^)@m651pje5w*!3ax^(a0vioad8en!t!pg8w'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Place static files in a 'static' folder inside your project
]
